...
import { ForwardedRef, RefObject, useId, useImperativeHandle, useRef, useState } from 'react';
...
export interface AdProps {
    ...
    slotRef?: ForwardedRef<AdSlot> | null;
}
...
function Ad({
    ...
    return (
        <div
            ...
            ref={refObserver as RefObject<HTMLDivElement>}
        >
            <div
